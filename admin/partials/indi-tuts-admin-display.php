...
<div id="wrapper">
  <div class="textbereich">
	          <h2 class="f-right">Ihr Benutzer-Profil: <span class="orange">INDI-Admin</span></h2>
  </div>
...
<main>
  ...
  <label for="tab12">Landing-Page erstellen</label>
    
  <input id="tab13" type="radio" name="tabs">
  <label for="tab13">Landing-Page veröffentlichen</label>
    
  <input id="tab14" type="radio" name="tabs">
  <label for="tab14">Neue Seite erstellen und veröffentlichen</label>
    
  <input id="tab15" type="radio" name="tabs">
  <label for="tab15">Seiten und Blogbeiträge löschen</label>
	
  <input id="tab16" type="radio" name="tabs">
  <label for="tab16">Seitennavigation administrieren</label>
    
  <input id="tab17" type="radio" name="tabs">
  <label for="tab17">Daten Import/Export</label>
	
  <input id="tab18" type="radio" name="tabs">
  <label for="tab18">Widgets administrieren</label>
	
  <input id="tab19" type="radio" name="tabs">
  <label for="tab19">Benutzer einrichten / ändern</label>
	
  <input id="tab20" type="radio" name="tabs">
  <label for="tab20">Designmodifikator</label>
	
  <input id="tab21" type="radio" name="tabs">
  <label for="tab21">Zusatzmodule installieren und administrieren</label>
...
<div class="top-border"></div>   
  ...
  <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/247309808' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
	  <p>
		  Code für das Unterdrücken der Navigation: 
		  <p>
			  #main-header, #main-footer {display: none;} #page-container {padding-top: 0px!Important;}
	  </p>
	  </p>
  </section>
	
  <section id="content13">
   <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/247312958' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content14">
    <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255210667' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content15">
    <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255363870' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content16">
   <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255368519' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content17">
   <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255371498' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content18">
    <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255377405' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
  ...
  <section id="content20">
    <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255409997' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content21">
   <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://player.vimeo.com/video/255424162' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  </section>
	
  <section id="content22">
    <p>
      <img src="../wp-content/themes/indigo-rise/includes/images/wird_aktualisiert.jpg" alt="In Bearbeitung">
    </p>
  </section>
